...
class Controller:
    def __init__(self, db_name=None):
        # Algatab mudeli, vaate ja mänguaja
        self.__model = Model()
    ...
    def main(self):
        # Käivitab programmi põhiloogika, käivitades vaate
        self.__view.main()

    def btn_scoreboard_click(self):
        # Käivitab nupu "Edetabel" klõpsamisel edetabeli akna
    ...
    def buttons_no_game(self):
        # Keelab nupud, kui mäng ei ole käimas
    ...
    def buttons_game(self):
        # Lülitab sisse nupud, kui mäng on käimas
    ...
    def btn_new_click(self):
        # Käivitab uue mängu nupu klõpsamisel
        self.buttons_game()
    ...
    def btn_cancel_click(self):
        # Katkestab mängu nupu klõpsamisel
    ...
    def btn_send_click(self):
        # Töötleb nupu "Saada" klõpsamist, kui kasutaja sisestab tähe
